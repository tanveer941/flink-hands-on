...
public class AverageProfitTumblingEvent {
  public static void main(String[] args) throws Exception {
    ...
    sum.addSink(StreamingFileSink
      .forRowFormat(new Path("/Users/tanveem/non_work/builder_winner_git/flink-hands-on/windowing-stream/tumbling_output/event_time"),
        new SimpleStringEncoder < Tuple2 < Long, String >> ("UTF-8"))
      .withRollingPolicy(DefaultRollingPolicy.builder().build())
      .build());

    // execute program
    env.execute("Windowing Event Time");
  }
}
